<section class="container my-5 parallax-container">
    <div class="section-title text-moon mb-5 mt-5">
        ...
        <ul class="ms-auto mt-5 d-inline-flex nav-social list-unstyled">
            ...
            <li class="nav-item">
                <a href="https://t.me/moon_lounge" target="_blank" class="nav-link"><i class="fab fa-telegram"></i></a>
            </li>
            <li class="nav-item">
                <a href="https://vk.com/moon_lounge_bar" target="_blank" class="nav-link"><i class="fab fa-vk"></i></a>
            </li>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-md-5">
            <div id="slide-window">
                ...
                <a data-fancybox="hero" href="{{ asset('videos/hero-video1.mp4') }}" class="d-none">
                    <img src="{{ asset('videos/hero-image1.jpg') }}" alt="hero image" />
                </a>
            </div>

        </div>
        <div class="col-md-6 content-text mt-4">
            <h2 class="title">О нашем ресторане</h2>
            <hr>
            <p>Moon Lounge - это уникальное место, которое предлагает совершенно новый формат заведения ресторана.
                Это место, где вы можете расслабиться и отдохнуть после тяжелого рабочего дня, наслаждаясь уютной
                и приятной атмосферой.</p>
            <p>Здесь вы сможете попробовать разнообразные блюда, приготовленные из свежих и качественных продуктов.
                В меню вы найдете множество авторских кулинарных произведений, которые созданы нашими опытными поварами</p>
            <p>Мы уверены, что каждый посетитель сможет найти в нашем заведении что-то для себя: от молодежных вечеринок
                до романтических свиданий. Наша команда профессионалов с радостью поможет вам выбрать блюдо и напиток по вашему вкусу.</p>
        </div>
